...
package clusterutil.clustering.view;
...
import clusterutil.MarkerManager;
...
import clusterutil.projection.Point;
import clusterutil.projection.SphericalMercatorProjection;
import clusterutil.ui.IconGenerator;
...
import static clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
        clusterutil.clustering.view.ClusterRenderer<T> {
    ...
    private clusterutil.ui.SquareTextView makeSquareTextView(Context context) {
        clusterutil.ui.SquareTextView squareTextView =
                new clusterutil.ui.SquareTextView(context);
